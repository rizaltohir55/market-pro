...
@section('title', 'Derivatives & Options')
@section('page-title', 'Derivatives & Options')
    ...
    <div class="panel acrylic flex-col" style="height: 800px;">
        <div class="panel-header fixed-header" style="flex-wrap: wrap; gap: var(--space-2)">
            ...
            <div style="display:flex; gap: 8px; flex: 1; min-width: 250px;">
                <input type="text" id="opt-symbol" class="form-input" value="{{ $symbol }}" style="width:100px; text-transform:uppercase" placeholder="Symbol">
    ...
    <div class="panel acrylic flex-col" style="height: 800px;">
        <div class="panel-header fixed-header">
            ...
            <div class="panel-actions">
                ...
                <button aria-label="Refresh Futures" class="btn btn-ghost btn-sm btn-sweep" onclick="loadCryptoFutures()">
