...
let sseSource = null;
function initSSE() {
    sseSource = new EventSource('<?php echo e(url('/api/market/stream')); ?>?page=dashboard'); // Dashboard stream has watchlist & top_pairs needed here
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\market_pro\resources\views/settings/index.blade.php ENDPATH**/ ?>