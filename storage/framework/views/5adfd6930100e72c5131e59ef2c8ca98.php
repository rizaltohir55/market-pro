...
<head>
    ...
    <title>MarketPro | <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
    ...
    <div class="app-layout" id="app">
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                <div class="nav-section">
                    ...
                    <a href="/" class="nav-item <?php echo e(request()->is('/') ? 'active' : ''); ?>" id="nav-dashboard">
                    ...
                    <a href="/trading" class="nav-item <?php echo e(request()->is('trading*') ? 'active' : ''); ?>" id="nav-trading">
                    ...
                    <a href="/scanner" class="nav-item <?php echo e(request()->is('scanner*') ? 'active' : ''); ?>" id="nav-scanner">
                    ...
                    <a href="/analysis" class="nav-item <?php echo e(request()->is('analysis*') ? 'active' : ''); ?>" id="nav-analysis">
                    ...
                    <a href="/settings" class="nav-item <?php echo e(request()->is('settings*') ? 'active' : ''); ?>" id="nav-settings">
                ...
                <div class="nav-section nav-section--markets">
                    ...
                    <a href="/equity" class="nav-item <?php echo e(request()->is('equity*') ? 'active' : ''); ?>" id="nav-equity">
                        <span class="nav-emoji">📊</span>
                        <span>Equity Analytics</span>
                    </a>
                    <a href="/fx-rates" class="nav-item <?php echo e(request()->is('fx-rates*') ? 'active' : ''); ?>" id="nav-fx">
                        <span class="nav-emoji">💱</span>
                        <span>FX & Rates</span>
                    </a>
                    <a href="/derivatives" class="nav-item <?php echo e(request()->is('derivatives*') ? 'active' : ''); ?>" id="nav-deriv">
                        <span class="nav-emoji">🎯</span>
                        <span>Derivatives</span>
                    </a>
                    <a href="/commodities" class="nav-item <?php echo e(request()->is('commodities*') ? 'active' : ''); ?>" id="nav-commod">
                        <span class="nav-emoji">🔶</span>
                        <span>Commodities</span>
                    </a>
                    <a href="/news" class="nav-item <?php echo e(request()->is('news*') ? 'active' : ''); ?>" id="nav-news">
                        <span class="nav-emoji">📰</span>
        ...
        <header class="topbar">
            <div class="topbar-left">
                ...
                <h1 class="topbar-title"><?php echo $__env->yieldContent('page-title', 'Dashboard Overview'); ?></h1>
            </div>
...
<?php /**PATH D:\Project\market_pro\resources\views/layouts/app.blade.php ENDPATH**/ ?>