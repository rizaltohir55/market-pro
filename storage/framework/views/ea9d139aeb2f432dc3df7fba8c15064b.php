...
<div class="kpi-grid fade-in-up" id="kpi-grid" style="--delay: 0.1s;">
    ...
    <div class="kpi-card js-tilt acrylic" id="kpi-card-<?php echo e($i); ?>">
        <div class="kpi-header">
            <span class="kpi-label"><?php echo e($kpi['label']); ?></span>
            <span class="kpi-icon" style="font-size:1.2rem; filter:drop-shadow(0 0 8px var(--accent-glow))"><?php echo e($kpi['icon']); ?></span>
        </div>
        <div class="kpi-value">
...
function initSSE() {
    const sseSource = new EventSource('<?php echo e(url('/api/market/stream')); ?>?page=dashboard');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\market_pro\resources\views/dashboard/index.blade.php ENDPATH**/ ?>