...
<?php $__env->startSection('title', 'Equity Analytics'); ?>
<?php $__env->startSection('page-title', 'Equity Analytics'); ?>

<?php $__env->startSection('content'); ?>
<div style="margin-bottom: var(--space-4); display: flex; gap: var(--space-2);">
    <input type="text" id="symbol-input" value="<?php echo e($symbol); ?>" class="form-input" style="width: 200px; text-transform: uppercase;" placeholder="Enter Stock Symbol (e.g. AAPL)">
...
<div class="grid-2 fade-in-up" style="--delay: 0.1s; align-items: stretch;">
    ...
    <div class="panel acrylic">
        <div class="panel-header">
            <span class="panel-title">📉 Valuation (<span id="disp-symbol"><?php echo e($symbol); ?></span>)</span>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\market_pro\resources\views/equity/index.blade.php ENDPATH**/ ?>