...
<?php $__env->startSection('title', 'Chart Builder (G)'); ?>
<?php $__env->startSection('page-title', 'Multi-Asset Chart Builder (G)'); ?>
...
<script>
const initialSymbols = <?php echo json_encode($symbols, 15, 512) ?>;
let currentTf = '1h';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\market_pro\resources\views/chart_builder/index.blade.php ENDPATH**/ ?>